    ...
    <div class="card">
        <div class="card-header">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('dashboard.holiday_message') <small>{{ $emails->count() }}</small></h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if (auth()->user()->hasPermission('markets_create'))
                                    <a href="{{route('HolidayMessage.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('dashboard.add')</a>
                                @else
