...
<div class="c-subheader justify-content-between px-3">
    ...
    <ol class="breadcrumb border-0 m-0 px-0 px-md-3">
        ...
        <li class="breadcrumb-item"><a href="{{ route('HolidayMessage.index') }}">@lang('dashboard.holiday_message')</a></li>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    {{-- {{dd($ticits->id)}} --}}
                    <form action="{{ route('HolidayMessage.store') }}" method="post" enctype="multipart/form-data">
