                ...
                <div class="col-sm-12">
                    ...
                    <form action="{{ route('dashboard.sub_categories.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="parent_category_id" class="form-control{{ $errors->has('parent_cat_id') ? ' is-invalid' : '' }}">
                        ...
                        <div class="form-group">
                            <img src="{{ asset('uploads/sub_category_images/default.png') }}"  style="width: 100px" class="img-thumbnail image-preview" alt="">
                            @if ($errors->has('image'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('image') }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" name="color1" class="form-control{{ $errors->has('color1') ? ' is-invalid' : '' }}" value="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="color" name="color2" class="form-control{{ $errors->has('color2') ? ' is-invalid' : '' }}" value="{{ old('color2') }}">
