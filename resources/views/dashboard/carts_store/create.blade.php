        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <form action="{{ route('dashboard.carts_store.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cart_code" class="form-control{{ $errors->has('cart_code') ? ' is-invalid' : '' }}" value="{{ old('cart_code') }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach ($products as $product)
                                <option value="{{ $product->id }}"> {{ $product->cart_details->cart_name }} - {{ $product->amrecan_price }}</option>
                            @endforeach
                            </select>
                        </div>
