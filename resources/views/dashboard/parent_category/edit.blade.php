        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <form action="{{ route('dashboard.parent_category.update', $parent_category->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <img src="{{ $parent_category->image_path }}"  style="width: 100px" class="img-thumbnail image-preview" alt="">
                            @if ($errors->has('image'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('image') }}</strong>
                                </span>
