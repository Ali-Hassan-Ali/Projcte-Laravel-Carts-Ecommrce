...
<body style="background:#F0F2F7;font-family: Cairo !important">
    <div class="box-latter" style=" width:30%;margin: auto;background: #F0F2F7;padding: 20px;">
        <div style="text-align: center;">
            ...
            <p style=" text-align:center; color: #777;padding: 0 40px;line-height: 1.5;">الرسائل الشهرية <a href="http://127.0.0.1:8000/en/Contact-Us" target="_blank"> تواصل معنا</a></p>
        </div>
