    ...
    <div class="box-latter" style=" width:30%;margin: auto;background: #F0F2F7;padding: 20px;">
        ...
        <div  style="background:#fff !important;padding:20px;border-radius:10px;">
        	<div class="content-ing" style="margin-bottom:40px;text-align: center;">
				<h2 style="font-size:19px;text-align: center">عمليه شراء ناجحة بمبلغ اجمالي {{$purchases->rate}} {{$purchases->totalprice}} </h2>

					
					<p style="text-align: center"><strong>  المنتج: </strong> {{$purchases->cart_name }}</p>
					<p style="text-align: center"><strong>الكمية:</strong>1</p>
                    ...
                    <a href="" style="overflow-wrap: break-word">{!! $purchases->code !!}</a><br>
					</div>
